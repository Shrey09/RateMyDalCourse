...
4) Then follow the steps mentioned below:-
    ...
    - Install node modules in the current directory using the command "npm install". This will install and upgrade the existing node 	  	      modules for the frontend part for the web 
